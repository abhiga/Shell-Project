...
static const yytype_int8 yyrhs[] =
{
      ...
      17,    -1,    18,    24,    23,     6,    -1,     6,    -1,     1,
       6,    -1,    18,    10,    19,    -1,    19,    -1,    22,    20,
      -1,    20,    21,    -1,    -1,     3,    -1,     3,    -1,     9,
      -1,    -1,    24,    25,    -1,    -1,     5,     3,    -1,     7,
       3,    -1,     8,     3,    -1,    11,     3,    -1,    12,     3,
      -1
};
...
static const char *const yytname[] =
{
  ...
  "LESS", "GREATAMPERSAND", "AMPERSAND", "PIPE", "GREATGREATAMPERSAND",
  "GREATGREAT", "$accept", "goal", "commands", "command", "simple_command",
  "pipe_list", "command_and_args", "arg_list", "argument", "command_word",
  "background_optional", "iomodifier_list", "iomodifier_opt", 0
};
#endif
...
static const yytype_uint8 yystos[] =
{
      ...
      22,     6,     0,    16,    10,    24,    20,    19,     5,     7,
       8,     9,    11,    12,    23,    25,     3,    21,     3,     3,
       3,     3,     3,     6
};
...
#line 85 "shell.y"
	...
	if (!(strchr((yyvsp[(1) - (1)].string_val), '*') == NULL && strchr((yyvsp[(1) - (1)].string_val), '?') == NULL)) {
		...
		checkThenInsert((yyvsp[(1) - (1)].string_val));
}
    break;
